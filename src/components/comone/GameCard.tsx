      ...
      <div className="px-5 py-5">
        ...
        <div className="w-full mt-2 flex flex-col gap-3">
          ...
          <Link
            to={item.game_url}
            target="_blank"
            className="absoulte bottom-1  text-white game-link-btn focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
          >
            Vist Game
          </Link>
        </div>
